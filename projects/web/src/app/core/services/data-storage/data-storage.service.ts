...
export class DataStorageService {
    ...
    getAllProductsHttpRequest() {
        return this.httpClient.get<ProductInterface[]>(
            environment.apiBaseUrl + '/getAllProducts.php',
            {},
        );
        // .pipe()
    }
    ...
    getAllCategoriesHttpRequest() {
        return this.httpClient.get<CategoryInterface[]>(
            environment.apiBaseUrl + '/getAllCategories.php',
            {},
        );
        // .pipe()
    }
    ...
    signUp(
        ...
        return this.httpClient.post<UserInterface | any>(
            environment.apiBaseUrl + '/signup.php', // El any es para cubrirme las espaldas por si la API devuelve un mensaje de error como: {resultado: "SQLSTATE[23000]: Integrity constraint violation: 1…ry 'hewemim@mailinator.com' for key 'users.email'"}
            {
                firstName: firstName,
                lastName: lastName,
                email: email,
    ...
    logIn(email: string, password: string, lastLoginFullDate: string, token: string) {
        ...
        return this.httpClient.post<UserInterface | any>(
            environment.apiBaseUrl + '/login.php', // El any es para cubrirme las espaldas por si la API devuelve un mensaje de error como: {resultado: "SQLSTATE[23000]: Integrity constraint violation: 1…ry 'hewemim@mailinator.com' for key 'users.email'"}
            {
                email: email,
                password: password,
                lastLoginFullDate: lastLoginFullDate,
    ...
    getOrderDataHttpRequest(orderNumber: number) {
        return this.httpClient.post<GetOrderDataPHPInterface>(
            environment.apiBaseUrl + '/getOrderData.php',
            {
    ...
    getOrdersHttpRequest(authToken: UserInterface['token']) {
        return this.httpClient.post<GetOrdersPHPInterface>(
            environment.apiBaseUrl + '/getOrders.php',
            {
                authToken: authToken,
            },
            {},
    ...
    getAddressesHttpRequest(authToken: UserInterface['token']) {
        return this.httpClient.post<GetAddressesPHPInterface>(
            environment.apiBaseUrl + '/getAddresses.php',
            {
                authToken: authToken,
            },
            {},
    ...
    getPaymentMethodsHttpRequest(authToken: string) {
        return this.httpClient.post<GetPaymentMethodsPHPInterface>(
            environment.apiBaseUrl + '/getPaymentMethods.php',
            {
                authToken: authToken,
            },
            {},
    ...
    changeDefaultPaymentMethod(authToken: string, paymentMethodId: PaymentMethodInterface['id']) {
        return this.httpClient.post<boolean>(
            environment.apiBaseUrl + '/changeDefaultPaymentMethod.php',
            {
                authToken: authToken,
    ...
    getAllCountriesHttpRequest() {
        return this.httpClient.get<CountryInterface[]>(
            environment.apiBaseUrl + '/getAllCountries.php',
            {},
        );
        // .pipe()
    }
    ...
    addNewAddressHttpRequest(
        ...
        return this.httpClient.post<number>(
            environment.apiBaseUrl + '/addNewAddress.php', // El any es para cubrirme las espaldas por si la API devuelve un mensaje de error como: {resultado: "SQLSTATE[23000]: Integrity constraint violation: 1…ry 'hewemim@mailinator.com' for key 'users.email'"}
            {
    ...
    changeDefaultAddress(authToken: string, addressId: AddressInterface['id']) {
        return this.httpClient.post<boolean>(
            environment.apiBaseUrl + '/changeDefaultAddress.php',
            {
                authToken: authToken,
                addressId: addressId,
            },
    ...
    addNewCardHttpRequest(
        ...
        return this.httpClient.post<number>(
            environment.apiBaseUrl + '/addNewCard.php', // El any es para cubrirme las espaldas por si la API devuelve un mensaje de error como: {resultado: "SQLSTATE[23000]: Integrity constraint violation: 1…ry 'hewemim@mailinator.com' for key 'users.email'"}
            {
                newCard: newCard,
                authToken: authToken,
            },
    ...
    getCartDataHttpRequest(authToken: string) {
        return this.httpClient.post<GetCartDataPHPInterface['cartData']>(
            environment.apiBaseUrl + '/getCartData.php',
            {
                authToken: authToken,
            },
            {},
    ...
    updateProductQuantityHttpRequest(
        ...
        return this.httpClient.post<boolean>(
            environment.apiBaseUrl + '/updateProductQuantity.php',
            {
                authToken: authToken,
                productId: productId,
    ...
    deleteProductFromCartHttpRequest(authToken: string, productId: ProductInterface['id']) {
        return this.httpClient.post<boolean>(
            environment.apiBaseUrl + '/deleteProductFromCart.php',
            {
                authToken: authToken,
                productId: productId,
            },
    ...
    addProductToCartHttpRequest(authToken: string, productSlug: ProductInterface['slug']) {
        return this.httpClient.post<boolean>(
            environment.apiBaseUrl + '/addProductToCart.php',
            {
                authToken: authToken,
    ...
    saveOrderHttpRequest(
        ...
        return this.httpClient.post<boolean>(
            environment.apiBaseUrl + '/saveOrder.php',
            {
                authToken: authToken,
    ...
    getCurrentProductReviewsHttpRequest(currentProductSlug: ProductInterface['slug']) {
        return this.httpClient.post<GetCurrentProductReviewsPHPInterface[]>(
            environment.apiBaseUrl + '/getCurrentProductReviews.php',
            {
