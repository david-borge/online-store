...
export class DataStorageService {
  ...
  addNewAddressHttpRequest(
    ...
    return this.httpClient
      .post<GetAddressesPHPInterface["addresses"][0]>(environment.apiBaseUrl + '/addNewAddress.php', // El any es para cubrirme las espaldas por si la API devuelve un mensaje de error como: {resultado: "SQLSTATE[23000]: Integrity constraint violation: 1…ry 'hewemim@mailinator.com' for key 'users.email'"}
      {
