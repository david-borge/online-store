...
const routes: Routes = [
    ...
    // Product Page
    {
        path: 'product',
        loadChildren: () =>
            import('./features/ecommerce/product/product.module').then(
                (modulo) => modulo.ProductModule,
            ),
    },
    ...
    // Categories Page (/categories)
    {
        path: 'categories',
        loadChildren: () =>
            import('./features/ecommerce/categories/categories.module').then(
                (modulo) => modulo.CategoriesModule,
            ),
    },
    ...
    // Category Page (/category/tech)
    {
        path: 'category',
        loadChildren: () =>
            import('./features/ecommerce/category/category.module').then(
                (modulo) => modulo.CategoryModule,
            ),
    },
    ...
    // Cart Page
    {
        path: 'cart',
        loadChildren: () =>
            import('./features/ecommerce/cart/cart.module').then((modulo) => modulo.CartModule),
    },
    ...
    // Account Page
    {
        path: 'account',
        loadChildren: () =>
            import('./features/ecommerce/account/account.module').then(
                (modulo) => modulo.AccountModule,
            ),
    },
    ...
    // Orders Page
    {
        path: 'orders',
        loadChildren: () =>
            import('./features/ecommerce/orders/orders.module').then(
                (modulo) => modulo.OrdersModule,
            ),
    },
    ...
    // Order Page (/order/1234)
    {
        path: 'order',
        loadChildren: () =>
            import('./features/ecommerce/order/order.module').then((modulo) => modulo.OrderModule),
    },
    ...
    // Addresses Page
    {
        path: 'addresses',
        loadChildren: () =>
            import('./features/ecommerce/addresses/addresses.module').then(
                (modulo) => modulo.AddressesModule,
            ),
    },
    ...
    // Payment Methods Page
    {
        ...
        loadChildren: () =>
            import('./features/ecommerce/payment-methods/payment-methods.module').then(
                (modulo) => modulo.PaymentMethodsModule,
            ),
    },
    ...
    // Checkout Step Pages
    {
        path: 'checkout',
        loadChildren: () =>
            import('./features/ecommerce/checkout/checkout.module').then(
                (modulo) => modulo.CheckoutModule,
            ),
    },
];
