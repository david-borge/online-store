...
export class AddNewAddressFormComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.store.dispatch(
            AddressesActions.GetAllCountriesStart({
      ...
      */
        ...
        this.addNewAddressForm.statusChanges.subscribe((statusChanges) => {
            // Comprobación
            ...
            if (statusChanges === 'VALID') {
                ...
                this.store.dispatch(
                    AddressesActions.SaveNewAddressToStore({
                        newAddressPayload: {
                        ...
                        newAddressCountryNamePayload:
                            this.addNewAddressForm.get('countryId')?.value,
                    }),
                );
            }
        });
