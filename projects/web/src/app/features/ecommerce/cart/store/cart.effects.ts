...
export class CartEffects {
    ...
    updateProductQuantitySideEffect = createEffect(() => this.actionsObservable.pipe(  // Cuidado: las Actions son Observables, pero no hace falta llamar a subscribe() al definir los Side Effects, eso lo hace NgRx automáticamente. Llamar solo a pipe().
        ...
        switchMap( (updateProductQuantityStartActionData) => {
            ...
            // CUIDADO: poner el tipo de llamada (get, post...) y el tipo de dato que devuelve apropiadamente.
            return this.dataStorageService.updateProductQuantityHttpRequest( this.cookiesService.leerUnaCookie("authToken"), updateProductQuantityStartActionData[0].productIdPayload, updateProductQuantityStartActionData[0].productQuantityPayload)
                .pipe(
                        ...
                        if ( updateProductQuantityHttpRequestResponse == true ) {
                            ...
                            return of(
                                ...
                                CartActions.UpdateProductQuantityEndSuccess({
                                    cartDataArrayIdPayload : updateProductQuantityStartActionData[0].cartDataArrayIdPayload,
                                    productQuantityPayload : updateProductQuantityStartActionData[0].productQuantityPayload,
                                    productIdPayload       : updateProductQuantityStartActionData[0].productIdPayload,
                                }),
                            ...
                            return of(
                                CartActions.UpdateProductQuantityEndFailure({
                                    updateProductQuantityErrorMessagePayload: 'There was an error when loading the Country list.',
                                }),
                            );
