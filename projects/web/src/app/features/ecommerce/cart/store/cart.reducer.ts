...
export const cartReducer = createReducer(
    ...
    on(CartActions.GetCartDataEndSuccess, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(CartActions.GetCartDataEndFailure, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(CartActions.UpdateProductQuantityEndFailure, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(CartActions.DeleteProductFromCartStart, (state, action) => {
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(CartActions.DeleteProductFromCartEndFailure, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(CartActions.AddProductToCartEndFailure, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
