...
export class HomeEffects {
    ...
    getCurrentProductReviewsSideEffect = createEffect(() => this.actionsObservable.pipe(  // Cuidado: las Actions son Observables, pero no hace falta llamar a subscribe() al definir los Side Effects, eso lo hace NgRx automáticamente. Llamar solo a pipe().
        ...
        switchMap( (getCurrentProductReviewsStartActionData) => {
            ...
            // CUIDADO: poner el tipo de llamada (get, post...) y el tipo de dato que devuelve apropiadamente.
            return this.dataStorageService.getCurrentProductReviewsHttpRequest( getCurrentProductReviewsStartActionData[0].currentProductSlugPayload )
                .pipe(
                    ...
                    switchMap( (getCurrentProductReviewsResponse: GetCurrentProductReviewsPHPInterface[]) => {
                        ...
                        return of(
                            ...
                            HomeActions.GetCurrentProductReviewsEndSuccess({
                                currentProductReviewsPayload: getCurrentProductReviewsResponse,
                            }),
                    ...
                    catchError(errorResponse => {
                        ...
                        return of(
                            HomeActions.GetCurrentProductReviewsEndFailure({
                                getCurrentProductReviewsErrorMessagePayload: 'There was an error when loading this product\'s reviews.',
                            }),
                        );
