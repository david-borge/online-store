...
export const addressesReducer = createReducer(
    ...
    on(AddressesActions.GetAddressesEndSuccess, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(AddressesActions.GetAllCountriesEndSuccess, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(AddressesActions.GetAllCountriesEndFailure, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    on(AddressesActions.AddNewAddressEndSuccess, (state, action) => {
    ...
    on(AddressesActions.AddNewAddressEndFailure, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
    ...
    // Side Effects asociados: addNewAddressSideEffect (toma los datos de la Addresses desde la base de datos mediante un HTTP Request)
    on(AddressesActions.SaveNewAddressToStore, (state, action) => ({
        /* Añadir un valor */
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
        ...
        newAddressCountryName: state.countries.find(
            (country) => country.id === +action.newAddressCountryNamePayload,
        )?.name,
    ...
    on(AddressesActions.ChangeDefaultAddressStart, (state, action) => {
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
