...
export const orderReducer = createReducer(
    ...
    on(OrderActions.SaveCurrentOrderSlug, (state, action) => ({
        /* Añadir un valor */
    ...
    on(OrderActions.GetOrderDataEndSuccess, (state, action) => ({
        // El Reducer devuelve la App State ya alterada por la Action (aka Reduced State).
        ...
        orderPaymentMethod:
            action.orderDataProductsAddressAndPaymentMethodPayload.orderPaymentMethod,
    })),
