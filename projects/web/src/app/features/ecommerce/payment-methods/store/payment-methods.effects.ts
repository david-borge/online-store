                    ...
                    switchMap(getPaymentMethodsHttpRequestResponse => {
                        ...
                        return of(
                            ...
                            PaymentMethodsActions.GetPaymentMethodsEndSuccess({
                                paymentMethodsPayload: getPaymentMethodsHttpRequestResponse.paymentMethods,
                            }),
                    ...
                    catchError(errorResponse => {
                        ...
                        return of(
                            PaymentMethodsActions.GetPaymentMethodsEndFailure({
                                getPaymentMethodsErrorMessagePayload: 'There was an error when loading the PaymentMethod data.',
                            }),
                        );
